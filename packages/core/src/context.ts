...
import { newSimpleError } from "./error";

export const ContextCancelledError = newSimpleError("context cancelled", {
	name: "ContextCancelled",
});

/**
 * Super simple synchronous implementation of a go-like context, allowing for long-running
...
export class Context {
	...
	cancel() {
		...
		return this.#done || this.#parent.done();
	}
}
